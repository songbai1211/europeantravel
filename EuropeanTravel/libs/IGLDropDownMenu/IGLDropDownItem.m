...
- (void)updateLayout
{
    ...
    [self.iconImageView setFrame:CGRectMake(self.paddingLeft, (selfHeight-20)/2, 30, 20)];
    if (self.iconImage) {
        [self.textLabel setFrame:CGRectMake(60, 0, selfWidth - CGRectGetMaxX(self.iconImageView.frame), selfHeight)];
    } else {
